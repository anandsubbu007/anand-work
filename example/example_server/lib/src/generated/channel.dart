...
class Channel extends TableRow {
  ...
  static Future<List<Channel>> insertOrupdateBulk(
    Session session,
    List<Channel> row, {
    Transaction? transaction,
  }) async {
    return session.db
        .insertOrupdateBulk<Channel>(row, Channel.t, transaction: transaction);
  }
  ...
  static Future<List> findDistinctValue(
    ...
    return session.db.findDistinctValue<Channel>(
      where: where != null ? where(Channel.t) : null,
      columns: columns,
